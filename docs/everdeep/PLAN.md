...
| V33 | MED | **The road NETWORK is patchy at survey zoom**: fantasy-Germany shows ONE road line in a ~400-mi frame while England and the US-East show full connected nets at the same ppf (r3-11 vs r3-12/r3-15). Not a draw gate — `ROUTE_MIN_PPF.road`=2e-4 was satisfied. | ✅ DIAGNOSED (audit-r3 fix lane; probe5-v33): the net is INNOCENT — the Germany box holds 8 road routes / 784 road-miles, proportionate to its settlements. The gap is upstream: that 400-mi box contains just **12 settlements** vs England 22, US-East 20, India 30, China 206, because the 1,500 seed cities are the GLOBAL population top list, which Asian metros dominate — mid-Europe keeps only Berlin-class giants, and villages feed off cities so they thin too. Fix is a data-source decision (per-country city minimums, or a density-raster town synthesis), which is Worldcraft Lane-L demography territory — queued to DECISIONS/the Worldcraft plan rather than patched here. |
