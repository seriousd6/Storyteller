...
| **Globe view, polar compression, edge wrap** (owner, 2026-07-12 batch 6) | Bounded worlds gain a full-world zoom stop; zooming past it morphs into a spinning orthographic globe (smooth slide back to flat); the flat map becomes an equirectangular projection — poles compress, and E–W panning wraps seamlessly. ⚠️ Requires x-periodic terrain noise — must be decided before genVersion 1 freezes at M1 (MAPS.md §3.2) | Map M1 decision + M2/M4 build |
